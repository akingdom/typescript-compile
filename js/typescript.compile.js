...
if(typeof TSCOMPILE_autocompile === 'undefined')
TSCOMPILE_autocompile = true;

const TSCOMPILE = {}

TSCOMPILE.hashCode = function(s) {
    var hsh = 0, chr, i;
    if(s.length == 0) {
        return hsh;
    }
 ...
 */
TSCOMPILE.translate = function(src) {
